...
def index():
    ...
    if request.method == 'POST':
        ...
        test_img.convert('RGB').save(os.path.join(app.config['INITIAL_FILE_UPLOADS'], 'test_image.jpg'))
        ...
        return render_template('index.html', score = str(round(score * 100, 2)) + '%' + ' match')